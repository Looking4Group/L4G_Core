...
UPDATE `creature` SET `spawnmask` = 1 WHERE `id` IN (18528,22861,22862,22863,22864,12270,12271,24937,22987,22982,23016,23415,23257,22967,22966,23473,23115,22919,22980,23363,22941,23383);
UPDATE `creature` SET `spawnmask` = 1 WHERE `guid` IN (84715,79011,79033,8313,2126,2115,12235,12234,12177,12236,96669,79015,79031,79030,79013,79014,44255,44257,44254,48166,86834,44256,91786,91785,91781,91789,91792,91780,91784,91782,91783,91788,91787,91790,91791,91793);
