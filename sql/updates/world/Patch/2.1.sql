...
UPDATE `creature` SET `spawnmask` = 1 WHERE `id` IN (18528,22861,22862,22863,22864,12270,12271,22987,22982,23016,23415,23257,22967,22966,23473,23115,22919,22980,23363,22941,23383,23219);
