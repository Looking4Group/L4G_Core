...
((@GUID := @GUID + '0'), 18969, 530, 1, 0, 1343, -230.412, 1071.51, 54.308, 1.53589, 300, 0, 0, 110000, 50250, 0, 0);

-- Justinus the Harbinger
DELETE FROM `creature` WHERE `creature`.`id` = 18966;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES
((@GUID := @GUID + '1'), 18966, 530, 1, 0, 1516, -269.361, 1071.2, 54.3077, 1.65806, 300, 0, 0, 99000, 47325, 0, 0);
...
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES
((@GUID := @GUID + '1'), 18965, 530, 1, 0, 29, -269.663, 1086.26, 46.2537, 1.5708, 300, 0, 0, 13000, 100, 0, 0),
((@GUID := @GUID + '1'), 18965, 530, 1, 0, 29, -269.932, 1083.3, 48.2155, 1.5708, 300, 0, 0, 13000, 100, 0, 0),
((@GUID := @GUID + '1'), 18965, 530, 1, 0, 29, -260.176, 1086.36, 46.2835, 1.5708, 300, 0, 0, 13000, 100, 0, 0),
((@GUID := @GUID + '1'), 18965, 530, 1, 0, 29, -260.593, 1083.48, 48.1924, 1.5708, 300, 0, 0, 13000, 100, 0, 0),
((@GUID := @GUID + '1'), 18965, 530, 1, 0, 29, -265.322, 1083.37, 48.2152, 1.48597, 300, 0, 0, 13000, 100, 0, 0),
((@GUID := @GUID + '1'), 18965, 530, 1, 0, 29, -265.187, 1086.36, 46.23, 1.5708, 300, 0, 0, 13000, 100, 0, 0),
((@GUID := @GUID + '1'), 18965, 530, 1, 0, 29, -307.406, 1021.64, 54.2668, 0.146198, 300, 0, 0, 13000, 100, 0, 0);
...
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES
((@GUID := @GUID + '1'), 18970, 530, 1, 0, 36, -239.295, 1084.09, 48.0014, 1.36136, 300, 0, 0, 12652, 0, 0, 0),
((@GUID := @GUID + '1'), 18970, 530, 1, 0, 36, -238.914, 1087.51, 45.7332, 1.36136, 300, 0, 0, 12652, 0, 0, 0),
((@GUID := @GUID + '1'), 18970, 530, 1, 0, 36, -232.08, 1087.71, 45.671, 1.48353, 300, 0, 0, 12652, 0, 0, 0),
((@GUID := @GUID + '1'), 18970, 530, 1, 0, 36, -235.6, 1084.24, 47.9451, 1.43117, 300, 0, 0, 12652, 0, 0, 0),
((@GUID := @GUID + '1'), 18970, 530, 1, 0, 36, -235.585, 1087.55, 45.7428, 1.43117, 300, 0, 0, 12652, 0, 0, 0),
((@GUID := @GUID + '1'), 18970, 530, 1, 0, 36, -232.192, 1084.25, 47.968, 1.48353, 300, 0, 0, 12683, 0, 0, 0);
...
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES
((@GUID := @GUID + '1'), 18948, 530, 1, 0, 653, -266.078, 1093.61, 41.6783, 1.50098, 300, 0, 0, 9900, 100, 0, 0),
((@GUID := @GUID + '1'), 18948, 530, 1, 0, 653, -271.419, 1093.38, 42.0004, 1.37881, 300, 0, 0, 9900, 100, 0, 0),
((@GUID := @GUID + '1'), 18948, 530, 1, 0, 653, -257.699, 1093.79, 41.6667, 1.67552, 300, 0, 0, 9900, 100, 0, 0),
((@GUID := @GUID + '1'), 18948, 530, 1, 0, 653, -261.533, 1093.65, 41.6667, 1.58825, 300, 0, 0, 9900, 100, 0, 0),
((@GUID := @GUID + '1'), 18948, 530, 1, 0, 653, -321.577, 1009.27, 54.2265, 1.18111, 300, 0, 0, 9900, 100, 0, 0),
((@GUID := @GUID + '1'), 18948, 530, 1, 0, 653, -253.58, 1093.68, 41.6667, 1.46818, 300, 0, 0, 9900, 100, 0, 0);
...
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES
((@GUID := @GUID + '1'), 18986, 530, 1, 0, 1342, -271.966, 1097.95, 41.924, 1.60779, 300, 0, 0, 13000, 29330, 0, 0),
((@GUID := @GUID + '1'), 18986, 530, 1, 0, 1342, -263.989, 1098.2, 41.6714, 1.53589, 300, 0, 0, 13000, 29330, 0, 0),
((@GUID := @GUID + '1'), 18986, 530, 1, 0, 1342, -258.965, 1098.33, 41.6668, 1.64061, 300, 0, 0, 13000, 29330, 0, 0),
((@GUID := @GUID + '1'), 18986, 530, 1, 0, 1342, -267.882, 1098.1, 41.733, 1.60779, 300, 0, 0, 13000, 29330, 0, 0),
((@GUID := @GUID + '1'), 18986, 530, 1, 0, 1342, -314.189, 1020.64, 54.2497, 0.146198, 300, 0, 0, 13000, 29330, 0, 0),
((@GUID := @GUID + '1'), 18986, 530, 1, 0, 1342, -319.582, 1014.12, 54.2262, 1.18111, 300, 5, 0, 13000, 29330, 0, 1),
((@GUID := @GUID + '1'), 18986, 530, 1, 0, 1342, -254.634, 1098.42, 41.6668, 1.64061, 300, 0, 0, 13000, 29330, 0, 0);
...
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES
((@GUID := @GUID + '1'), 18950, 530, 1, 0, 133, -236.118, 1094.29, 41.6667, 1.51844, 300, 0, 0, 12000, 5280, 0, 0),
((@GUID := @GUID + '1'), 18950, 530, 1, 0, 133, -245.26, 1094.14, 41.6667, 1.37881, 300, 0, 0, 12000, 5280, 0, 0),
((@GUID := @GUID + '1'), 18950, 530, 1, 0, 133, -233.701, 1098.25, 41.6666, 1.41372, 300, 0, 0, 12000, 5280, 0, 0),
((@GUID := @GUID + '1'), 18950, 530, 1, 0, 133, -246.106, 1097.79, 41.6667, 1.41372, 300, 0, 0, 12000, 5280, 0, 0),
((@GUID := @GUID + '1'), 18950, 530, 1, 0, 133, -237.952, 1098.13, 41.6667, 1.5708, 300, 0, 0, 12000, 5280, 0, 0),
((@GUID := @GUID + '1'), 18950, 530, 1, 0, 133, -229.492, 1098.26, 41.6667, 1.41372, 300, 0, 0, 12000, 5280, 0, 0),
((@GUID := @GUID + '1'), 18950, 530, 1, 0, 133, -240.848, 1094.25, 41.6667, 1.44862, 300, 0, 0, 12000, 5280, 0, 0),
((@GUID := @GUID + '1'), 18950, 530, 1, 0, 133, -231.356, 1094.29, 41.6667, 1.58825, 300, 0, 0, 12000, 5280, 0, 0),
((@GUID := @GUID + '1'), 18950, 530, 1, 0, 133, -242.308, 1098.02, 41.6667, 1.48353, 300, 0, 0, 12000, 5280, 0, 0),
((@GUID := @GUID + '1'), 18950, 530, 1, 0, 133, -180.343, 1018.59, 54.2253, 2.42443, 300, 0, 0, 12000, 5280, 0, 0),
((@GUID := @GUID + '1'), 18950, 530, 1, 0, 133, -249.316, 1094.13, 41.6667, 1.64061, 300, 0, 0, 12000, 5280, 0, 0);

-- Orgrimmar Shaman
DELETE FROM `creature` WHERE `creature`.`id` = 18972;
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES
((@GUID := @GUID + '1'), 18972, 530, 1, 0, 0, -242.171, 1111.31, 41.6667, 1.57437, 300, 0, 0, 7900, 29330, 0, 0),
((@GUID := @GUID + '1'), 18972, 530, 1, 0, 0, -244.131, 1111.3, 41.6667, 1.57437, 300, 0, 0, 7900, 29330, 0, 0),
((@GUID := @GUID + '1'), 18972, 530, 1, 0, 0, -244.125, 1109.73, 41.6667, 1.57437, 300, 0, 0, 7900, 29330, 0, 0),
((@GUID := @GUID + '1'), 18972, 530, 1, 0, 0, -242.179, 1109.73, 41.6667, 1.57437, 300, 0, 0, 7900, 29330, 0, 0),
((@GUID := @GUID + '1'), 18972, 530, 1, 0, 0, -242.174, 1108.35, 41.6667, 1.57437, 300, 0, 0, 7900, 29330, 0, 0),
((@GUID := @GUID + '1'), 18972, 530, 1, 0, 0, -244.169, 1108.34, 41.6667, 1.57437, 300, 0, 0, 7900, 29330, 0, 0),
((@GUID := @GUID + '1'), 18972, 530, 1, 0, 0, -243.29, 1113.25, 41.6667, 1.57437, 300, 0, 0, 7900, 29330, 0, 0);
-- Correct Unit Flag
...
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES
((@GUID := @GUID + '1'), 30001, 530, 1, 0, 0, -292.791, 1143.22, 91.9368, 2.3911, 300, 0, 0, 1, 0, 0, 0),
((@GUID := @GUID + '1'), 30002, 530, 1, 0, 0, -266.624, 1154.46, 79.4764, 2.44346, 300, 0, 0, 1, 0, 0, 0),
((@GUID := @GUID + '1'), 30003, 530, 1, 0, 0, -266.312, 1099.08, 41.7916, 1.73303, 300, 0, 0, 1, 0, 0, 0),
((@GUID := @GUID + '1'), 30004, 530, 1, 0, 0, -234.448, 1097.6, 41.7916, 2.89898, 300, 0, 0, 1, 0, 0, 0);
...
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES
((@GUID := @GUID + '1'), 30005, 530, 1, 0, 0, -282.494, 1148.49, 41.5774, 4.70902, 300, 0, 0, 1, 0, 0, 0),
((@GUID := @GUID + '1'), 30005, 530, 1, 0, 0, -265.105, 1140.24, 41.6677, 4.76002, 300, 0, 0, 1, 0, 0, 0),
((@GUID := @GUID + '1'), 30005, 530, 1, 0, 0, -257.891, 1148.32, 41.6561, 4.71952, 300, 0, 0, 1, 0, 0, 0),
((@GUID := @GUID + '1'), 30005, 530, 1, 0, 0, -238.322, 1140.29, 41.6657, 4.67755, 300, 0, 0, 1, 0, 0, 0),
((@GUID := @GUID + '1'), 30005, 530, 1, 0, 0, -229.541, 1147.88, 41.65, 4.67755, 300, 0, 0, 1, 0, 0, 0),
((@GUID := @GUID + '1'), 30005, 530, 1, 0, 0, -213.682, 1139.87, 41.594, 4.67755, 300, 0, 0, 1, 0, 0, 0),
((@GUID := @GUID + '1'), 30005, 530, 1, 0, 0, -206.253, 1147.09, 41.5728, 4.67755, 300, 0, 0, 1, 0, 0, 0),
((@GUID := @GUID + '1'), 30005, 530, 1, 0, 0, -188.317, 1139.68, 41.5866, 4.72781, 300, 0, 0, 1, 0, 0, 0),
((@GUID := @GUID + '1'), 30005, 530, 1, 0, 0, -247.794, 1143.10, 41.6128, 4.72781, 300, 0, 0, 1, 0, 0, 0);
