DELETE FROM `waypoint_scripts` WHERE `id` IN ('0');

--
DELETE FROM `waypoint_scripts` WHERE `id` IN (310);
--
UPDATE `waypoint_data` SET `action`='1068' WHERE `id` IN (200932) AND `point` IN (5,10);
UPDATE `waypoint_data` SET `action`='1000' WHERE `id` IN (200932) AND `point` IN (6,11);
UPDATE `waypoint_data` SET `action`='1068' WHERE `id` IN (200931) AND `point` IN (1,7,13);
UPDATE `waypoint_data` SET `action`='1000' WHERE `id` IN (200931) AND `point` IN (2,8,14);
UPDATE `waypoint_data` SET `action`='1068' WHERE `id` IN (200948) AND `point` IN (1,4,13);
UPDATE `waypoint_data` SET `action`='1000' WHERE `id` IN (200948) AND `point` IN (2,5,14);
--

UPDATE `waypoint_data` SET `action`='1000' WHERE `id` IN ('28') AND `point` IN ('1','3');

DELETE FROM `waypoint_scripts` WHERE `id` BETWEEN 1000 AND 1476;
INSERT INTO `waypoint_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `dataint`, `x`, `y`, `z`, `o`, `guid`) VALUES
(1000,0,2,169,0,0,0,0,0,0,'ONESHOT_NONE'),
(1001,0,2,169,1,0,0,0,0,0,'ONESHOT_TALK'),
(1002,0,2,169,2,0,0,0,0,0,'ONESHOT_BOW'),
(1003,0,2,169,3,0,0,0,0,0,'ONESHOT_WAVE'),
(1004,0,2,169,4,0,0,0,0,0,'ONESHOT_CHEER'),
(1005,0,2,169,5,0,0,0,0,0,'ONESHOT_EXCLAMATION'),
(1006,0,2,169,6,0,0,0,0,0,'ONESHOT_QUESTION'),
(1007,0,2,169,7,0,0,0,0,0,'ONESHOT_EAT'),
(1010,0,2,169,10,0,0,0,0,0,'STATE_DANCE'),
(1011,0,2,169,11,0,0,0,0,0,'ONESHOT_LAUGH'),
(1012,0,2,169,12,0,0,0,0,0,'STATE_SLEEP'),
(1013,0,2,169,13,0,0,0,0,0,'STATE_SIT'),
(1014,0,2,169,14,0,0,0,0,0,'ONESHOT_RUDE'),
(1015,0,2,169,15,0,0,0,0,0,'ONESHOT_ROAR'),
(1016,0,2,169,16,0,0,0,0,0,'ONESHOT_KNEEL'),
(1017,0,2,169,17,0,0,0,0,0,'ONESHOT_KISS'),
(1018,0,2,169,18,0,0,0,0,0,'ONESHOT_CRY'),
(1019,0,2,169,19,0,0,0,0,0,'ONESHOT_CHICKEN'),
(1020,0,2,169,20,0,0,0,0,0,'ONESHOT_BEG'),
(1021,0,2,169,21,0,0,0,0,0,'ONESHOT_APPLAUD'),
(1022,0,2,169,22,0,0,0,0,0,'ONESHOT_SHOUT'),
(1023,0,2,169,23,0,0,0,0,0,'ONESHOT_FLEX'),
(1024,0,2,169,24,0,0,0,0,0,'ONESHOT_SHY'),
(1025,0,2,169,25,0,0,0,0,0,'ONESHOT_POINT'),
(1026,0,2,169,26,0,0,0,0,0,'STATE_STAND'),
(1027,0,2,169,27,0,0,0,0,0,'STATE_READYUNARMED'),
(1028,0,2,169,28,0,0,0,0,0,'STATE_WORK_SHEATHED'),
(1029,0,2,169,29,0,0,0,0,0,'STATE_POINT'),
(1030,0,2,169,30,0,0,0,0,0,'STATE_NONE'),
(1033,0,2,169,33,0,0,0,0,0,'ONESHOT_WOUND'),
(1034,0,2,169,34,0,0,0,0,0,'ONESHOT_WOUNDCRITICAL'),
(1035,0,2,169,35,0,0,0,0,0,'ONESHOT_ATTACKUNARMED'),
(1036,0,2,169,36,0,0,0,0,0,'ONESHOT_ATTACK1H'),
(1037,0,2,169,37,0,0,0,0,0,'ONESHOT_ATTACK2HTIGHT'),
(1038,0,2,169,38,0,0,0,0,0,'ONESHOT_ATTACK2HLOOSE'),
(1039,0,2,169,39,0,0,0,0,0,'ONESHOT_PARRYUNARMED'),
(1043,0,2,169,43,0,0,0,0,0,'ONESHOT_PARRYSHIELD'),
(1044,0,2,169,44,0,0,0,0,0,'ONESHOT_READYUNARMED'),
(1045,0,2,169,45,0,0,0,0,0,'ONESHOT_READY1H'),
(1048,0,2,169,48,0,0,0,0,0,'ONESHOT_READYBOW'),
(1050,0,2,169,50,0,0,0,0,0,'ONESHOT_SPELLPRECAST'),
(1051,0,2,169,51,0,0,0,0,0,'ONESHOT_SPELLCAST'),
(1053,0,2,169,53,0,0,0,0,0,'ONESHOT_BATTLEROAR'),
(1054,0,2,169,54,0,0,0,0,0,'ONESHOT_SPECIALATTACK1H'),
(1060,0,2,169,60,0,0,0,0,0,'ONESHOT_KICK'),
(1061,0,2,169,61,0,0,0,0,0,'ONESHOT_ATTACKTHROWN'),
(1064,0,2,169,64,0,0,0,0,0,'STATE_STUN'),
(1065,0,2,169,65,0,0,0,0,0,'STATE_DEAD'),
(1066,0,2,169,66,0,0,0,0,0,'ONESHOT_SALUTE'),
(1068,0,2,169,68,0,0,0,0,0,'STATE_KNEEL'),
(1069,0,2,169,69,0,0,0,0,0,'STATE_USESTANDING'),
(1070,0,2,169,70,0,0,0,0,0,'ONESHOT_WAVE_NOSHEATHE'),
(1071,0,2,169,71,0,0,0,0,0,'ONESHOT_CHEER_NOSHEATHE'),
(1092,0,2,169,92,0,0,0,0,0,'ONESHOT_EAT_NOSHEATHE'),
(1093,0,2,169,93,0,0,0,0,0,'STATE_STUN_NOSHEATHE'),
(1094,0,2,169,94,0,0,0,0,0,'ONESHOT_DANCE'),                
--
(1476,0,2,169,476,0,0,0,0,0,'ONESHOT_CRY (JAINA PROUDMOORE ONLY)');
--
