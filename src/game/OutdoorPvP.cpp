...
bool OPvPCapturePoint::Update(uint32 diff)
{
    ...
    Looking4group::AnyPlayerInObjectRangeCheck checker(m_capturePoint, radius);
    Looking4group::ObjectListSearcher<Player, Looking4group::AnyPlayerInObjectRangeCheck> searcher(players, checker);
