...
namespace VMAP
{
    ...
    class StaticMapTree
    {
        ...
        private:
            bool getIntersectionTime(const G3D::Ray& pRay, float &pMaxDist, bool pStopAtFirstHit = false, uint32 mapID = 0, bool pCheckLOS = false) const;
        ...
        public:
            ...
            bool isInLineOfSight(const G3D::Vector3& pos1, const G3D::Vector3& pos2, uint32 mapID) const;
