...
enum __QuestFlags
{
    ...
    QUEST_FLAGS_MONTHLY        = 0x00002000,
    ...
    QUEST_LOOKING4GROUP_FLAGS_MONTHLY              = 0x01000000,   // Set by 16 in SpecialFlags in DB if the quest is reset at the begining of the month
    QUEST_LOOKING4GROUP_FLAGS_DB_ALLOWED = 0xFFFF | QUEST_LOOKING4GROUP_FLAGS_REPEATABLE | QUEST_LOOKING4GROUP_FLAGS_EXPLORATION_OR_EVENT  | QUEST_LOOKING4GROUP_FLAGS_MONTHLY,
...
class Quest
{
    ...
    public:
        ...
        bool   IsMonthly() const { return QuestFlags & QUEST_FLAGS_MONTHLY; }
