...
void hyjalAI::HideNearPos(float x, float y)
{
    ...
    Looking4group::AllFriendlyCreaturesInGrid creature_check(m_creature);
    Looking4group::ObjectListSearcher<Creature, Looking4group::AllFriendlyCreaturesInGrid> creature_searcher(creatures, creature_check);
...
{
    RespawnDo u_do;
    Looking4group::ObjectWorker<Creature, RespawnDo> worker(u_do);
