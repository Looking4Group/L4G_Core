...
class SqlResultQueue : public ACE_Based::LockedQueue<Looking4group::IQueryCallback* , ACE_Thread_Mutex>
{
    public:
        SqlResultQueue() {}
        void Update();
...
class SqlQuery : public SqlOperation
{
    private:
        const char *m_sql;
        Looking4group::IQueryCallback * m_callback;
        SqlResultQueue * m_queue;
    public:
        SqlQuery(const char *sql, Looking4group::IQueryCallback * callback, SqlResultQueue * queue)
...
class SqlQueryHolder
{
    ...
    public:
        ...
        bool Execute(Looking4group::IQueryCallback * callback, SqlDelayThread *thread, SqlResultQueue *queue);
};
...
class SqlQueryHolderEx : public SqlOperation
{
    private:
        ...
        SqlResultQueue * m_queue;
    public:
        SqlQueryHolderEx(SqlQueryHolder *holder, Looking4group::IQueryCallback * callback, SqlResultQueue * queue)
